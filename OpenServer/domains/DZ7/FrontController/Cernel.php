...
/** class Kernel - является классом Front Controller, он обрабатывает все запросы к данному веб.приложению */
/** он взаимодействуют с данными классами
use Framework\Registry;  использует реестр для отрисовки страниц по URL
use Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use Symfony\Component\DependencyInjection\ContainerBuilder;  загружает содержимое с конфигурационных файлов
...
use Symfony\Component\Routing\RouteCollection;  инициирует добавление различных экшенов для открытия нужной страници сайта
*/
 class Kernel
{
    /**
